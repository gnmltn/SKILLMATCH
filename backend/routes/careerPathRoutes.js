...
const careerPathsData = [
  ...
  },
  {
    id: '11',
    title: 'Web Developer',
    description: 'Create and maintain websites using modern web technologies',
    icon: '🌐',
    requiredSkills: [
      { name: 'HTML', importance: 'critical', minProficiency: 80, category: 'WEB DEVELOPMENT' },
      { name: 'CSS', importance: 'critical', minProficiency: 80, category: 'WEB DEVELOPMENT' },
      { name: 'JavaScript', importance: 'critical', minProficiency: 75, category: 'PROGRAMMING' },
      { name: 'Git', importance: 'important', minProficiency: 65, category: 'TOOLS' },
      { name: 'Responsive Design', importance: 'important', minProficiency: 75, category: 'WEB DEVELOPMENT' },
      { name: 'Bootstrap', importance: 'important', minProficiency: 70, category: 'WEB DEVELOPMENT' },
      { name: 'jQuery', importance: 'important', minProficiency: 60, category: 'WEB DEVELOPMENT' },
      { name: 'PHP', importance: 'important', minProficiency: 65, category: 'PROGRAMMING' },
      { name: 'WordPress', importance: 'nice-to-have', minProficiency: 60, category: 'WEB DEVELOPMENT' },
      { name: 'SQL', importance: 'nice-to-have', minProficiency: 55, category: 'BACKEND' },
      { name: 'API Integration', importance: 'nice-to-have', minProficiency: 60, category: 'SOFTWARE ARCHITECTURE' },
    ],
    averageSalary: '₱60,000 - ₱100,000',
    demandLevel: 'high',
    growthRate: '+12% annually',
    experienceLevel: 'Entry to Mid-level',
    industries: ['Agency', 'Marketing', 'E-commerce', 'Small Business']
  },
  {
    id: '12',
    title: 'Data Engineer',
    ...
    requiredSkills: [
      { name: 'Python', importance: 'critical', minProficiency: 80, category: 'PROGRAMMING' },
      { name: 'SQL', importance: 'critical', minProficiency: 85, category: 'BACKEND' },
      { name: 'Database Design', importance: 'critical', minProficiency: 80, category: 'BACKEND' },
      { name: 'Data Pipeline', importance: 'critical', minProficiency: 75, category: 'DATA SCIENCE' },
      { name: 'ETL Processes', importance: 'critical', minProficiency: 75, category: 'DATA SCIENCE' },
      { name: 'MongoDB', importance: 'important', minProficiency: 70, category: 'BACKEND' },
      { name: 'PostgreSQL', importance: 'important', minProficiency: 75, category: 'BACKEND' },
      { name: 'AWS', importance: 'important', minProficiency: 70, category: 'DEVOPS & CLOUD' },
      { name: 'Docker', importance: 'important', minProficiency: 65, category: 'TOOLS' },
      { name: 'Git', importance: 'important', minProficiency: 70, category: 'TOOLS' },
      { name: 'Apache Spark', importance: 'nice-to-have', minProficiency: 60, category: 'DATA SCIENCE' },
      { name: 'Kafka', importance: 'nice-to-have', minProficiency: 55, category: 'DATA SCIENCE' },
      { name: 'Airflow', importance: 'nice-to-have', minProficiency: 60, category: 'DATA SCIENCE' },
    ],
    averageSalary: '₱90,000 - ₱150,000',
    demandLevel: 'very high',
    growthRate: '+23% annually',
    experienceLevel: 'Mid to Senior-level',
    industries: ['Tech', 'Finance', 'E-commerce', 'Analytics']
  },
  {
    id: '13',
    ...
    icon: '🤖',
    requiredSkills: [
      { name: 'Python', importance: 'critical', minProficiency: 85, category: 'PROGRAMMING' },
      { name: 'Machine Learning', importance: 'critical', minProficiency: 80, category: 'DATA SCIENCE' },
      { name: 'Statistics', importance: 'critical', minProficiency: 80, category: 'DATA SCIENCE' },
      { name: 'Data Analysis', importance: 'critical', minProficiency: 75, category: 'DATA SCIENCE' },
      { name: 'Pandas', importance: 'important', minProficiency: 75, category: 'PROGRAMMING' },
      { name: 'TensorFlow', importance: 'important', minProficiency: 70, category: 'DATA SCIENCE' },
      { name: 'PyTorch', importance: 'important', minProficiency: 70, category: 'DATA SCIENCE' },
      { name: 'SQL', importance: 'important', minProficiency: 70, category: 'BACKEND' },
      { name: 'Git', importance: 'important', minProficiency: 70, category: 'TOOLS' },
      { name: 'Docker', importance: 'nice-to-have', minProficiency: 65, category: 'TOOLS' },
      { name: 'AWS', importance: 'nice-to-have', minProficiency: 65, category: 'DEVOPS & CLOUD' },
      { name: 'Jupyter Notebooks', importance: 'nice-to-have', minProficiency: 70, category: 'DATA SCIENCE' },
    ],
    averageSalary: '₱100,000 - ₱160,000',
    demandLevel: 'very high',
    growthRate: '+28% annually',
    experienceLevel: 'Mid to Senior-level',
    industries: ['Tech', 'Finance', 'Healthcare', 'Automotive', 'AI Startups']
  },
  {
    id: '14',
    ...
    icon: '☁️',
    requiredSkills: [
      { name: 'AWS', importance: 'critical', minProficiency: 85, category: 'DEVOPS & CLOUD' },
      { name: 'Cloud Architecture', importance: 'critical', minProficiency: 85, category: 'DEVOPS & CLOUD' },
      { name: 'System Architecture', importance: 'critical', minProficiency: 80, category: 'SOFTWARE ARCHITECTURE' },
      { name: 'Kubernetes', importance: 'critical', minProficiency: 80, category: 'DEVOPS & CLOUD' },
      { name: 'Docker', importance: 'important', minProficiency: 75, category: 'TOOLS' },
      { name: 'Terraform', importance: 'important', minProficiency: 75, category: 'DEVOPS & CLOUD' },
      { name: 'CI/CD', importance: 'important', minProficiency: 75, category: 'DEVOPS & CLOUD' },
      { name: 'Linux/Unix', importance: 'important', minProficiency: 75, category: 'IT & INFRASTRUCTURE' },
      { name: 'Network Engineering', importance: 'important', minProficiency: 70, category: 'IT & INFRASTRUCTURE' },
      { name: 'Python', importance: 'nice-to-have', minProficiency: 65, category: 'PROGRAMMING' },
      { name: 'Azure', importance: 'nice-to-have', minProficiency: 65, category: 'DEVOPS & CLOUD' },
      { name: 'GCP', importance: 'nice-to-have', minProficiency: 60, category: 'DEVOPS & CLOUD' },
    ],
    averageSalary: '₱110,000 - ₱170,000',
    demandLevel: 'very high',
    growthRate: '+26% annually',
    experienceLevel: 'Senior-level',
    industries: ['Tech', 'Finance', 'Enterprise', 'Cloud Services', 'Consulting']
  },
  {
    id: '15',
    ...
    icon: '📋',
    requiredSkills: [
      { name: 'Product Management', importance: 'critical', minProficiency: 80, category: 'PROJECT MANAGEMENT' },
      { name: 'Agile Methodology', importance: 'critical', minProficiency: 75, category: 'PROJECT MANAGEMENT' },
      { name: 'User Research', importance: 'critical', minProficiency: 70, category: 'UI/UX DESIGN' },
      { name: 'Problem Solving', importance: 'important', minProficiency: 80, category: 'SOFTWARE ARCHITECTURE' },
      { name: 'Jira', importance: 'important', minProficiency: 70, category: 'PROJECT MANAGEMENT' },
      { name: 'Scrum', importance: 'important', minProficiency: 70, category: 'PROJECT MANAGEMENT' },
      { name: 'Data Analysis', importance: 'important', minProficiency: 65, category: 'DATA SCIENCE' },
      { name: 'Excel', importance: 'important', minProficiency: 70, category: 'TOOLS' },
      { name: 'API Design', importance: 'nice-to-have', minProficiency: 60, category: 'SOFTWARE ARCHITECTURE' },
      { name: 'SQL', importance: 'nice-to-have', minProficiency: 55, category: 'BACKEND' },
      { name: 'UI/UX Design', importance: 'nice-to-have', minProficiency: 60, category: 'UI/UX DESIGN' },
    ],
    averageSalary: '₱85,000 - ₱140,000',
    demandLevel: 'high',
    growthRate: '+18% annually',
    experienceLevel: 'Mid to Senior-level',
    industries: ['Tech', 'Startups', 'E-commerce', 'FinTech', 'SaaS']
  },
  {
    id: '16',
    ...
    requiredSkills: [
      { name: 'Data Analysis', importance: 'critical', minProficiency: 75, category: 'DATA SCIENCE' },
      { name: 'Excel', importance: 'critical', minProficiency: 80, category: 'TOOLS' },
      { name: 'SQL', importance: 'important', minProficiency: 70, category: 'BACKEND' },
      { name: 'Business Analysis', importance: 'critical', minProficiency: 75, category: 'PROJECT MANAGEMENT' },
      { name: 'Requirements Gathering', importance: 'critical', minProficiency: 75, category: 'PROJECT MANAGEMENT' },
      { name: 'Problem Solving', importance: 'important', minProficiency: 75, category: 'SOFTWARE ARCHITECTURE' },
      { name: 'Agile Methodology', importance: 'important', minProficiency: 65, category: 'PROJECT MANAGEMENT' },
      { name: 'Jira', importance: 'important', minProficiency: 65, category: 'PROJECT MANAGEMENT' },
      { name: 'Data Visualization', importance: 'nice-to-have', minProficiency: 65, category: 'DATA SCIENCE' },
      { name: 'Python', importance: 'nice-to-have', minProficiency: 60, category: 'PROGRAMMING' },
      { name: 'Power BI', importance: 'nice-to-have', minProficiency: 60, category: 'TOOLS' },
    ],
    averageSalary: '₱65,000 - ₱110,000',
    demandLevel: 'high',
    growthRate: '+16% annually',
    experienceLevel: 'Entry to Mid-level',
    industries: ['Finance', 'Healthcare', 'Consulting', 'Tech', 'Retail']
  },
  {
    id: '17',
    ...
    requiredSkills: [
      { name: 'SQL', importance: 'critical', minProficiency: 85, category: 'BACKEND' },
      { name: 'Database Design', importance: 'critical', minProficiency: 85, category: 'BACKEND' },
      { name: 'PostgreSQL', importance: 'critical', minProficiency: 80, category: 'BACKEND' },
      { name: 'MongoDB', importance: 'important', minProficiency: 75, category: 'BACKEND' },
      { name: 'MySQL', importance: 'important', minProficiency: 75, category: 'BACKEND' },
      { name: 'Database Optimization', importance: 'critical', minProficiency: 80, category: 'BACKEND' },
      { name: 'System Administration', importance: 'important', minProficiency: 70, category: 'IT & INFRASTRUCTURE' },
      { name: 'Linux/Unix', importance: 'important', minProficiency: 70, category: 'IT & INFRASTRUCTURE' },
      { name: 'Backup & Recovery', importance: 'important', minProficiency: 75, category: 'IT & INFRASTRUCTURE' },
      { name: 'Python', importance: 'nice-to-have', minProficiency: 60, category: 'PROGRAMMING' },
      { name: 'Docker', importance: 'nice-to-have', minProficiency: 60, category: 'TOOLS' },
    ],
    averageSalary: '₱80,000 - ₱125,000',
    demandLevel: 'high',
    growthRate: '+15% annually',
    experienceLevel: 'Mid to Senior-level',
    industries: ['Tech', 'Finance', 'Enterprise', 'Healthcare', 'E-commerce']
  },
  {
    id: '18',
    title: 'System Administrator',
    description: 'Maintain and manage IT infrastructure and server systems',
    icon: '🖥️',
    requiredSkills: [
      { name: 'Linux/Unix', importance: 'critical', minProficiency: 80, category: 'IT & INFRASTRUCTURE' },
      { name: 'System Administration', importance: 'critical', minProficiency: 80, category: 'IT & INFRASTRUCTURE' },
      { name: 'Network Engineering', importance: 'critical', minProficiency: 75, category: 'IT & INFRASTRUCTURE' },
      { name: 'Bash Scripting', importance: 'important', minProficiency: 75, category: 'IT & INFRASTRUCTURE' },
      { name: 'Docker', importance: 'important', minProficiency: 70, category: 'TOOLS' },
      { name: 'Git', importance: 'important', minProficiency: 65, category: 'TOOLS' },
      { name: 'Backup & Recovery', importance: 'important', minProficiency: 75, category: 'IT & INFRASTRUCTURE' },
      { name: 'Monitoring Tools', importance: 'important', minProficiency: 70, category: 'IT & INFRASTRUCTURE' },
      { name: 'Python', importance: 'nice-to-have', minProficiency: 60, category: 'PROGRAMMING' },
      { name: 'AWS', importance: 'nice-to-have', minProficiency: 65, category: 'DEVOPS & CLOUD' },
      { name: 'Kubernetes', importance: 'nice-to-have', minProficiency: 60, category: 'DEVOPS & CLOUD' },
    ],
    averageSalary: '₱70,000 - ₱115,000',
    demandLevel: 'high',
    growthRate: '+13% annually',
    experienceLevel: 'Entry to Mid-level',
    industries: ['Tech', 'Enterprise', 'Finance', 'Government', 'Healthcare']
  },
  {
    id: '19',
    ...
    icon: '✍️',
    requiredSkills: [
      { name: 'Technical Writing', importance: 'critical', minProficiency: 85, category: 'OTHER' },
      { name: 'Documentation', importance: 'critical', minProficiency: 80, category: 'OTHER' },
      { name: 'Git', importance: 'important', minProficiency: 65, category: 'TOOLS' },
      { name: 'Markdown', importance: 'important', minProficiency: 75, category: 'TOOLS' },
      { name: 'API Documentation', importance: 'important', minProficiency: 70, category: 'SOFTWARE ARCHITECTURE' },
      { name: 'User Research', importance: 'important', minProficiency: 65, category: 'UI/UX DESIGN' },
      { name: 'HTML', importance: 'nice-to-have', minProficiency: 60, category: 'WEB DEVELOPMENT' },
      { name: 'CSS', importance: 'nice-to-have', minProficiency: 55, category: 'WEB DEVELOPMENT' },
      { name: 'JavaScript', importance: 'nice-to-have', minProficiency: 50, category: 'PROGRAMMING' },
      { name: 'UI/UX Design', importance: 'nice-to-have', minProficiency: 55, category: 'UI/UX DESIGN' },
    ],
    ...
    growthRate: '+12% annually',
    experienceLevel: 'Entry to Mid-level',
    industries: ['Tech', 'Software', 'API Services', 'Open Source', 'Enterprise']
  },
  {
    id: '20',
    title: 'Scrum Master',
    ...
    icon: '🔄',
    requiredSkills: [
      { name: 'Scrum', importance: 'critical', minProficiency: 85, category: 'PROJECT MANAGEMENT' },
      { name: 'Agile Methodology', importance: 'critical', minProficiency: 85, category: 'PROJECT MANAGEMENT' },
      { name: 'Jira', importance: 'critical', minProficiency: 80, category: 'PROJECT MANAGEMENT' },
      { name: 'Team Leadership', importance: 'critical', minProficiency: 75, category: 'PROJECT MANAGEMENT' },
      { name: 'Problem Solving', importance: 'important', minProficiency: 75, category: 'SOFTWARE ARCHITECTURE' },
      { name: 'Communication', importance: 'important', minProficiency: 80, category: 'OTHER' },
      { name: 'Git', importance: 'nice-to-have', minProficiency: 60, category: 'TOOLS' },
      { name: 'Software Development Lifecycle', importance: 'nice-to-have', minProficiency: 70, category: 'PROJECT MANAGEMENT' },
      { name: 'CI/CD', importance: 'nice-to-have', minProficiency: 55, category: 'DEVOPS & CLOUD' },
    ],
    averageSalary: '₱75,000 - ₱120,000',
    demandLevel: 'high',
    growthRate: '+17% annually',
    experienceLevel: 'Mid-level',
    industries: ['Tech', 'Finance', 'Enterprise', 'Consulting', 'Startups']
  }
];
...
const skillVariations = {
  ...
  'database optimization': ['query optimization', 'database performance', 'db optimization'],
  'backup & recovery': ['backup', 'disaster recovery', 'data recovery', 'backup recovery'],
  
  // Web Development (Additional)
  'responsive design': ['mobile responsive', 'responsive web design', 'mobile first'],
  'jquery': ['jquery library', 'jquery framework'],
  'php': ['php programming', 'php development'],
  'wordpress': ['wp', 'wordpress development', 'wordpress cms'],
  'api integration': ['rest api integration', 'api connection', 'api consumption'],
  
  // Data Science & Engineering
  'data pipeline': ['etl pipeline', 'data processing pipeline', 'pipeline'],
  'etl processes': ['extract transform load', 'etl', 'data etl'],
  'apache spark': ['spark', 'apache spark framework'],
  ...
  // Project Management
  'product management': ['product mgmt', 'product strategy', 'product ownership'],
  'business analysis': ['business analyst', 'ba skills', 'business requirements'],
  'requirements gathering': ['requirements', 'requirement analysis', 'gathering requirements'],
  'team leadership': ['leadership', 'team management', 'leadership skills'],
  'communication': ['verbal communication', 'written communication', 'communication skills'],
  'software development lifecycle': ['sdlc', 'software lifecycle', 'development lifecycle'],
  
  // Technical Writing & Documentation
  'technical writing': ['tech writing', 'documentation writing', 'technical documentation'],
  'documentation': ['docs', 'technical docs', 'software documentation'],
  'markdown': ['md', 'markdown syntax'],
  'api documentation': ['api docs', 'swagger', 'openapi'],
  
  // Infrastructure & Tools
  'monitoring tools': ['monitoring', 'system monitoring', 'application monitoring'],
